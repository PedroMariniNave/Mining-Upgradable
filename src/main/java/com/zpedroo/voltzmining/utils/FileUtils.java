...
public class FileUtils {
    ...
    public Set<String> getSection(Files file, String path) {
        if (!getFile(file).get().contains(path)) return null;
        if (getFile(file).get().getConfigurationSection(path) == null) return null;
    ...
    public enum Files {
        ...
        TOP("top", "menus", "menus"),
        EDIT_MINE("edit_mine", "menus", "menus"),
        MINE_BLOCKS("mine_blocks", "menus", "menus");
